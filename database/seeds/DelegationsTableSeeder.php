...
class DelegationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=1;$i<=7;$i++) {
            $delegations['Ariana'][] = array('nom_delegation'=>trans('delegations.Ariana_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=9;$i++) {
            $delegations['Beja'][] = array('nom_delegation'=>trans('delegations.Beja_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=12;$i++) {
            $delegations['Ben_Arous'][] = array('nom_delegation'=>trans('delegations.Ben_Arous_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=14;$i++) {
            $delegations['Bizerte'][] = array('nom_delegation'=>trans('delegations.Bizerte_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=10;$i++) {
            $delegations['Gabes'][] = array('nom_delegation'=>trans('delegations.Gabes_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=11;$i++) {
            $delegations['Gafsa'][] = array('nom_delegation'=>trans('delegations.Gafsa_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=9;$i++) {
            $delegations['Jendouba'][] = array('nom_delegation'=>trans('delegations.Jendouba_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=11;$i++) {
            $delegations['Kairouan'][] = array('nom_delegation'=>trans('delegations.Kairouan_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=13;$i++) {
            $delegations['Kasserine'][] = array('nom_delegation'=>trans('delegations.Kasserine_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=6;$i++) {
            $delegations['Kebili'][] = array('nom_delegation'=>trans('delegations.Kebili_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=8;$i++) {
            $delegations['La_Manouba'][] = array('nom_delegation'=>trans('delegations.La_Manouba_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=11;$i++) {
            $delegations['Le_Kef'][] = array('nom_delegation'=>trans('delegations.Le_Kef_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=11;$i++) {
            $delegations['Mahdia'][] = array('nom_delegation'=>trans('delegations.Mahdia_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=9;$i++) {
            $delegations['Medenine'][] = array('nom_delegation'=>trans('delegations.Medenine_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=13;$i++) {
            $delegations['Monastir'][] = array('nom_delegation'=>trans('delegations.Monastir_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=16;$i++) {
            $delegations['Nabeul'][] = array('nom_delegation'=>trans('delegations.Nabeul_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=15;$i++) {
            $delegations['Sfax'][] = array('nom_delegation'=>trans('delegations.Sfax_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=12;$i++) {
            $delegations['Sidi_Bouzid'][] = array('nom_delegation'=>trans('delegations.Sidi_Bouzid_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=11;$i++) {
            $delegations['Siliana'][] = array('nom_delegation'=>trans('delegations.Siliana_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=16;$i++) {
            $delegations['Sousse'][] = array('nom_delegation'=>trans('delegations.Sousse_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=7;$i++) {
            $delegations['Tataouine'][] = array('nom_delegation'=>trans('delegations.Tataouine_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=5;$i++) {
            $delegations['Tozeur'][] = array('nom_delegation'=>trans('delegations.Tozeur_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=21;$i++) {
            $delegations['Tunis'][] = array('nom_delegation'=>trans('delegations.Tunis_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
        ...
        for($i=1;$i<=6;$i++) {
            $delegations['Zaghouan'][] = array('nom_delegation'=>trans('delegations.Zaghouan_'.$i), 'gouvernorat_id'=>$gouvernorat_id, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'));
        }
