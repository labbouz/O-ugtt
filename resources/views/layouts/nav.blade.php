...
<li>
    <a href="javascript:void(0)" class="waves-effect {{ active(['secteur.*','move.*']) }}"><i data-icon="P" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">@lang('main.configuration')<span class="fa arrow"></span></span></a>
    <ul class="nav nav-second-level">
        ...
        <li><a href="{{ route('violation.index') }}"><i data-icon="K" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">@lang('main.violations_individuelles')</span></a> </li>
